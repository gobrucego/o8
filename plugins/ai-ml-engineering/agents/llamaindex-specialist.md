...
|------|-------------|-------|
| llamaindex-specialist | Expert LlamaIndex developer specializing in RAG systems, document indexing, query engines, and production-ready data-centric AI applications | sonnet |
