...
description: 'Expert in generating Mermaid diagrams for architecture (C4 model L0-L3), data flows, sequence diagrams, and user journey flows. Creates visual documentation that renders beautifully in Markdown.'
model: inherit
sandbox:
  enabled: true
  allowed_write_paths:
