---
id: swiftui-specialist
category: agent
tags: [mobile, ios, android, app-development]
capabilities:

useWhen:
  - Working with Swiftui technology stack requiring deep expertise in configuration, optimization, best practices, and production deployment patterns
  - Implementing Swiftui-specific features, integrations, or troubleshooting complex issues requiring specialized domain knowledge
estimatedTokens: 300
---
...
**Output Directory**: `.orchestr8/docs/mobile/`

**Naming Convention**: `[type]-[name]-YYYY-MM-DD.md`

### Output Examples:
- **Report**: `.orchestr8/docs/mobile/[component]-YYYY-MM-DD.md`
