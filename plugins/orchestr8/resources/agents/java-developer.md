...
id: java-developer
category: agent
tags: [java, development, programming, implementation]
capabilities:

useWhen:
  - Implementing features, services, or applications using Java with focus on idiomatic patterns, best practices, and framework-specific optimizations
  - Building production-grade Java code with proper error handling, testing, type safety, and performance considerations
estimatedTokens: 300
---
