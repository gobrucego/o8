...
useWhen:
  - Designing comprehensive testing strategies including unit tests, integration tests, e2e tests, and test automation frameworks
  - Ensuring high test coverage, writing test cases for edge conditions, and implementing continuous testing in CI/CD pipelines
estimatedTokens: 300
---
