...
useWhen:
  - Investigating complex bugs, runtime errors, performance issues, or unexpected behavior requiring systematic debugging and root cause analysis
  - Using debugging tools, profilers, memory analyzers, and logging frameworks to diagnose and fix production issues
estimatedTokens: 300
---
