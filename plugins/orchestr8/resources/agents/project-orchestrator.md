...
Specialized agents are available in the `/agents/` directory, organized by domain. Select appropriate specialists based on project phase requirements:

**Phase 1 (Planning):**
- `architect` - System design and technology decisions
- `requirements-analyzer` - Requirements extraction and validation

**Phase 2 (Development):**
- `backend-developer` - Server-side implementation
- `frontend-developer` - UI/UX implementation
- `fullstack-developer` - Complete feature development
...
**Phase 4 (Deployment):**
- `ci-cd-engineer` - CI/CD pipeline setup
