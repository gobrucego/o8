---
id: compose-specialist
category: agent
tags: [mobile, ios, android, app-development]
capabilities:

useWhen:
  - Working with Compose technology stack requiring deep expertise in configuration, optimization, best practices, and production deployment patterns
  - Implementing Compose-specific features, integrations, or troubleshooting complex issues requiring specialized domain knowledge
estimatedTokens: 300
---
