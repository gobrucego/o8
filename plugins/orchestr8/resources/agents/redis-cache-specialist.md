---
id: redis-cache-specialist
category: agent
tags: [database, data, persistence, storage]
capabilities:

useWhen:
  - Designing, optimizing, or troubleshooting Redis Cache database schemas, queries, performance, replication, and production deployments
