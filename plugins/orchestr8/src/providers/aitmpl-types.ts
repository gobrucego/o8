...
export const AITMPL_DATA_SOURCES = {
  ...
  METADATA_JSON:
    "https://raw.githubusercontent.com/davila7/claude-code-templates/main/docs/components-metadata.json",

  /** Trending data */
  TRENDING_JSON:
    "https://raw.githubusercontent.com/davila7/claude-code-templates/main/docs/trending-data.json",
