...
```bash
# Local resource
/now "use o8://agents/typescript-developer to build an API"
...
Source: o8://skills/web-server-patterns
...
2. **Command Loads:**
   ...
   **→ Load Dynamic Expertise:** 
   o8://match?query=build+TypeScript+REST+API&categories=agent,skill,pattern,workflow&maxTokens=4000
   ```
...
│ - Contains: o8://match?query=${ARGUMENTS}...         │
└────────────────────┬────────────────────────────────────────┘
                     │
                     ▼
┌─────────────────────────────────────────────────────────────┐
