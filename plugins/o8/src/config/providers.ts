...
export class ProviderConfigManager {
   ...
   */
  private isAitmplConfigured(): boolean {
   ...
   */
  private isCustomConfigured(): boolean {
   ...
   */
  async enableProvider(provider: "aitmpl" | "github" | "custom"): Promise<void> {
    this.ensureInitialized();
   ...
   */
  async disableProvider(provider: "aitmpl" | "github" | "custom"): Promise<void> {
    this.ensureInitialized();
