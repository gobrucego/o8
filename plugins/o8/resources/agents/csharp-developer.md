...
id: csharp-developer
category: agent
tags: [csharp, development, programming, implementation]
capabilities:

useWhen:
  - Implementing features, services, or applications using Csharp with focus on idiomatic patterns, best practices, and framework-specific optimizations
  - Building production-grade Csharp code with proper error handling, testing, type safety, and performance considerations
estimatedTokens: 300
---
