...
**Example:** `o8://examples/database/neo4j-recommendation-engine`
...
**Example:** `o8://examples/database/neo4j-graph-algorithms`
...
**Example:** `o8://examples/database/neo4j-nodejs-driver`
