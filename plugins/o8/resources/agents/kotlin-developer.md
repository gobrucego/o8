...
id: kotlin-developer
category: agent
tags: [kotlin, development, programming, implementation]
capabilities:

useWhen:
  - Implementing features, services, or applications using Kotlin with focus on idiomatic patterns, best practices, and framework-specific optimizations
  - Building production-grade Kotlin code with proper error handling, testing, type safety, and performance considerations
estimatedTokens: 300
---
