...
relatedResources:
  ...
  - o8://examples/git-troubleshooting-scenarios
...
- **Basic Git**: Load `o8://agents/git-expert`
- **GitHub-specific**: Load `o8://agents/github-workflow-specialist`
- **Merge strategies**: Load `o8://skills/git-rebase-merge`
