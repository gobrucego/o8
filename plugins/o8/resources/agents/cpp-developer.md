...
id: cpp-developer
category: agent
tags: [cpp, development, programming, implementation]
capabilities:

useWhen:
  - Implementing features, services, or applications using Cpp with focus on idiomatic patterns, best practices, and framework-specific optimizations
  - Building production-grade Cpp code with proper error handling, testing, type safety, and performance considerations
estimatedTokens: 378
---
