---
id: algolia-specialist
category: agent
tags: [specialized, expert, domain-specific]
capabilities:

useWhen:
  - Working with Algolia technology stack requiring deep expertise in configuration, optimization, best practices, and production deployment patterns
  - Implementing Algolia-specific features, integrations, or troubleshooting complex issues requiring specialized domain knowledge
estimatedTokens: 300
---
