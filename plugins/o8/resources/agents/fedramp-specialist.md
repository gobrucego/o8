---
id: fedramp-specialist
category: agent
tags: [compliance, regulatory, security, audit]
capabilities:

useWhen:
  - Working with Fedramp technology stack requiring deep expertise in configuration, optimization, best practices, and production deployment patterns
  - Implementing Fedramp-specific features, integrations, or troubleshooting complex issues requiring specialized domain knowledge
estimatedTokens: 300
---
