...
useWhen:
  ...
  - Optimizing token efficiency through o8://agents/match?query= dynamic loading based on specific user requests versus loading all expertise upfront
...
Usage:
o8://agents/match?query=python+api+rest
