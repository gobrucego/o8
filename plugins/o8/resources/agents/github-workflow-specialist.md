...
relatedResources:
  ...
  - o8://skills/github-cli-essentials
  - o8://guides/ci-cd-github-actions
  - o8://examples/github-actions-workflows
  - o8://examples/git-pr-templates
...
- **Git basics**: Load `o8://agents/git-expert`
- **PR workflow**: Load `o8://skills/git-pr-workflow`
- **CI/CD setup**: Load `o8://guides/ci-cd-github-actions`
