...
useWhen:
  ...
  - Improving agent discoverability through fuzzy matching by testing with o8://agents/match?query= and ensuring correct fragments appear for expected queries
...
API specialization:
o8://agents/match?query=typescript+api+rest
o8://agents/match?query=express+api+typescript

Async specialization:
o8://agents/match?query=typescript+async+promises
o8://agents/match?query=concurrent+typescript

Testing specialization:
o8://agents/match?query=typescript+testing+jest
o8://agents/match?query=unit+test+typescript
```
