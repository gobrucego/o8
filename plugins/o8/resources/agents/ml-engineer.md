...
**Example:** `o8://examples/ml/pytorch-transformer-classifier`
...
**Example:** `o8://examples/ml/tensorflow-keras-multi-input`
...
**Example:** `o8://examples/ml/hyperparameter-optimization-optuna`
...
- `o8://examples/ml/pytorch-transformer-classifier` (~280 tokens)
- `o8://examples/ml/tensorflow-keras-multi-input` (~260 tokens)
- `o8://examples/ml/hyperparameter-optimization-optuna` (~240 tokens)
