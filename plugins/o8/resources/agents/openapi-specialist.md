---
id: openapi-specialist
category: agent
tags: [api, integration, services]
capabilities:

useWhen:
  - Working with Openapi technology stack requiring deep expertise in configuration, optimization, best practices, and production deployment patterns
  - Implementing Openapi-specific features, integrations, or troubleshooting complex issues requiring specialized domain knowledge
estimatedTokens: 300
---
...
**Output Directory**: `.orchestr8/docs/api/`

**Naming Convention**: `[type]-[name]-YYYY-MM-DD.md`

### Output Examples:
- **Report**: `.orchestr8/docs/api/[component]-YYYY-MM-DD.md`
