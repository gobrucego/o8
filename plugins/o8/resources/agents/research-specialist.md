...
useWhen:
  ...
  - Conducting gap analysis to identify missing agent fragments, skill patterns, or examples needed for o8:// dynamic URI matching
  - Building requirement documents with measurable success criteria before Phase 2 design work using o8://match?query= resource discovery
...
- Check for existing fragments: `o8://match?query=${domain}`
...
o8://match?query=${topic}&categories=agent,skill,pattern,example
...
- Static fragments: o8://category/resource
- Dynamic queries: o8://match?query=...
...
**→ Research Agent:** `o8://agents/match?query=research+${domain}`
...
`o8://match?query=${findings}&categories=agent,pattern`
