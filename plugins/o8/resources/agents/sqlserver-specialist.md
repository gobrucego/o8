...
**Example:** `o8://examples/database/sqlserver-dmv-performance-tuning`
...
**Example:** `o8://examples/database/sqlserver-tsql-procedures`
...
**Example:** `o8://examples/database/sqlserver-always-on-availability`
...
**Example:** `o8://examples/database/sqlserver-security-features`
...
- `o8://examples/database/sqlserver-dmv-performance-tuning` (~240 tokens)
- `o8://examples/database/sqlserver-tsql-procedures` (~220 tokens)
- `o8://examples/database/sqlserver-always-on-availability` (~260 tokens)
- `o8://examples/database/sqlserver-security-features` (~200 tokens)
