...
category: agent
tags: [frontend, ui, web, client-side]
capabilities:

useWhen:
  - Working with Angular technology stack requiring deep expertise in configuration, optimization, best practices, and production deployment patterns
  - Implementing Angular-specific features, integrations, or troubleshooting complex issues requiring specialized domain knowledge
estimatedTokens: 300
---
...
**Output Directory**: `.orchestr8/docs/frontend/`

**Naming Convention**: `[type]-[name]-YYYY-MM-DD.md`

### Output Examples:
- **Report**: `.orchestr8/docs/frontend/[component]-YYYY-MM-DD.md`
