...
**Complete Implementation:**
```
o8://examples/infrastructure/sre-chaos-capacity
```
...
- `o8://examples/infrastructure/sre-slo-configuration` (~250 tokens)
- `o8://examples/infrastructure/sre-incident-management` (~300 tokens)
- `o8://examples/infrastructure/sre-chaos-capacity` (~280 tokens)
