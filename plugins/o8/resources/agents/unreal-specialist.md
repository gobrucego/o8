...
category: agent
tags: [game-development, gaming, engine]
capabilities:

useWhen:
  - Working with Unreal technology stack requiring deep expertise in configuration, optimization, best practices, and production deployment patterns
  - Implementing Unreal-specific features, integrations, or troubleshooting complex issues requiring specialized domain knowledge
estimatedTokens: 300
---
