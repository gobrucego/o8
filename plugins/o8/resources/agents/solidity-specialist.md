...
useWhen:
  - Working with Solidity technology stack requiring deep expertise in configuration, optimization, best practices, and production deployment patterns
  - Implementing Solidity-specific features, integrations, or troubleshooting complex issues requiring specialized domain knowledge
estimatedTokens: 300
---
...
**Output Directory**: `.orchestr8/docs/blockchain/`

**Naming Convention**: `[type]-[name]-YYYY-MM-DD.md`

### Output Examples:
- **Report**: `.orchestr8/docs/blockchain/[component]-YYYY-MM-DD.md`
