...
prerequisite: o8://agents/knowledge-base-agent
useWhen:
...
**Prerequisite:** Load `o8://agents/knowledge-base-agent` first for core KB capabilities.
...
```
Combine with: o8://agents/legacy-system-analyst
