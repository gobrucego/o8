...
- **o8://patterns/event-driven-best-practices** - Foundational principles for event systems
- **o8://patterns/event-driven-eventsourcing** - Combine CQRS with event sourcing
- **o8://patterns/event-driven-pubsub** - Event distribution infrastructure
- **o8://patterns/event-driven-saga** - Distributed transactions across services
- **o8://patterns/architecture-microservices** - Microservices architecture with CQRS
