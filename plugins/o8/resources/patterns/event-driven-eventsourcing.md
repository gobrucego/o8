...
- **o8://patterns/event-driven-best-practices** - Event validation, versioning, and DLQ patterns
- **o8://patterns/event-driven-cqrs** - Build read models from event streams
- **o8://patterns/event-driven-pubsub** - Event distribution and pub/sub infrastructure
- **o8://patterns/event-driven-saga** - Saga pattern for cross-aggregate workflows
- **o8://patterns/architecture-microservices** - Event sourcing in microservices
