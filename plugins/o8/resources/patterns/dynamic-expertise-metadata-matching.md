...
□ o8://agents/match?query=typescript+async
□ o8://agents/match?query=async+promises+typescript
□ o8://agents/match?query=concurrent+operations
...
□ o8://skills/match?query=async+errors
□ o8://skills/match?query=try+catch+async
□ o8://skills/match?query=promise+rejection
