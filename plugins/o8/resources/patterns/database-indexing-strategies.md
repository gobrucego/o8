...
- **o8://patterns/database-query-optimization** - Eliminate N+1 queries and optimize ORM usage
- **o8://patterns/database-connection-pooling-scaling** - Scale database with pooling and replicas
- **o8://patterns/performance-caching** - Cache query results to reduce database load
