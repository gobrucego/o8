...
- **o8://patterns/event-driven-pubsub** - Pub/sub messaging with Kafka/RabbitMQ
- **o8://patterns/event-driven-cqrs** - Command Query Responsibility Segregation
- **o8://patterns/event-driven-eventsourcing** - Event sourcing with aggregate patterns
- **o8://patterns/event-driven-saga** - Distributed transactions with compensation
- **o8://patterns/message-broker-comparison** - Kafka vs RabbitMQ vs AWS SQS/SNS
