...
- **o8://patterns/database-indexing-strategies** - Add indexes to speed up queries
- **o8://patterns/database-connection-pooling-scaling** - Connection pooling and read replicas
- **o8://patterns/performance-caching** - Cache queries with Redis to reduce database hits
