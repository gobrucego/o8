...
```markdown
**→ Research Expertise:**
o8://agents/match?query=research+${domain}+requirements&mode=index&maxResults=5

**→ Research Skills:**
o8://skills/match?query=domain+research+requirement+analysis&mode=index&maxResults=3
```
...
o8://agents/match?query=${tech-stack}+${domain}&mode=index&maxResults=8

**→ Architectural Patterns:**
o8://patterns/match?query=${architecture-style}+${domain}&mode=index&maxResults=5
```
...
o8://match?query=${tech}+${features}+${architecture}&categories=agent,skill,example&mode=index&maxResults=10

**→ Testing Skills:**
o8://skills/match?query=testing+${tech}+${test-types}&mode=index&maxResults=5
```
...
```markdown
**→ Validation Skills:**
o8://skills/match?query=testing+validation+${domain}&mode=index&maxResults=3

**→ Meta-Skills for Knowledge Extraction:**
o8://skills/match?query=fragment+design+optimization&mode=index&maxResults=3
```
...
**→ Research Expertise:**
o8://match?query=research+requirements+${domain}&categories=agent,skill&mode=index&maxResults=5
...
**→ Domain Expertise:**
o8://match?query=${tech-stack}+${architecture}+${domain}&categories=agent,pattern&mode=index&maxResults=8
...
o8://match?query=validation+fragment+design&categories=skill&mode=index&maxResults=5
