...
**→ Load Patterns:** `o8://patterns/match?query=architecture+layered+microservices&mode=index&maxResults=3`
...
**→ Load Framework:** `o8://patterns/match?query=trade+off+analysis+architecture&mode=index&maxResults=3`
