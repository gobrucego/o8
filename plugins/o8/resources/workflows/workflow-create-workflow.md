...
useWhen:
  ...
  - Adaptive workflow design needing dynamic expertise assembly with o8:// URIs and progressive refinement patterns
estimatedTokens: 580
---
...
- o8://agents/match?query=research+${domain}&mode=index&maxResults=5
- o8://skills/match?query=requirements+analysis&mode=index&maxResults=3
...
- o8://skills/match?query=testing+${tech}&mode=index&maxResults=3
```
...
**Resource selection:**
- Static URIs for fixed dependencies: `o8://agents/typescript-developer`
- Dynamic URIs for variable needs: `o8://agents/match?query=${project-type}`
...
Discoverable via: o8://patterns/match?query=...
```
...
**→ Load:** o8://skills/match?query=debugging+${bug-description}&mode=index&maxResults=3
- Reproduce issue, analyze root cause
- **Checkpoint:** Cause identified

## Phase 2: Fix (30-80%)
**→ Load:** o8://match?query=${bug-description}+solution&mode=index&maxResults=5
