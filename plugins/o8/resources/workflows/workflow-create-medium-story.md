...
**→ Load:** o8://match?query=${topic}+research+analysis&categories=agent,skill&mode=index&maxResults=8
...
```
o8://skills/medium-publishing-comprehensive
```
...
**→ Load:** o8://skills/medium-api-publishing
...
**→ Load:** o8://agents/match?query=${tech-stack}&mode=index&maxResults=5

Add technical expertise to content creation phase.

### For Personal Development
**→ Load:** o8://skills/match?query=storytelling+personal-narrative&mode=index&maxResults=3

Enhance emotional storytelling and relatability.

### For Business/Career
**→ Load:** o8://skills/match?query=business+career+professional-development&mode=index&maxResults=3
