...
- o8://skills/performance-api-optimization - API optimization after identifying bottlenecks with profiling
- o8://skills/performance-database-optimization - Database optimization guided by profiling data
- o8://skills/performance-frontend-optimization - Frontend optimization using browser profiling tools

**Related Patterns:**
- o8://patterns/performance-caching - Caching patterns to address profiling-identified bottlenecks

**Implementation Examples:**
- o8://examples/* - Performance examples across different tech stacks

## Profiling Workflow

1. **Identify symptoms** - Slow responses, high CPU, memory growth
2. **Profile first** - Use this skill to identify actual bottlenecks
3. **Optimize specific layer** - Use domain-specific performance skills
4. **Measure improvement** - Re-profile to validate changes
5. **Repeat** - Continue until performance targets are met
