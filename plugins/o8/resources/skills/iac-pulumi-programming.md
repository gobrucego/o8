...
**Alternative Tool:**
- o8://skills/iac-terraform-modules - Infrastructure as code with Terraform

**Cross-Cutting Concepts:**
- o8://skills/iac-state-management - State management patterns (applies to Pulumi state)
- o8://skills/iac-testing-validation - Testing infrastructure code (tools work with Pulumi)
- o8://skills/iac-gitops-workflows - GitOps workflows for infrastructure deployment
