...
**See:**
- o8://skills/testing-integration - Basic integration patterns
- o8://skills/testing-integration-patterns - Advanced patterns with test containers
...
**See:** o8://skills/testing-e2e-best-practices
...
- **o8://skills/testing-unit** - Unit testing patterns and test doubles
- **o8://skills/testing-integration** - Integration test setup and API testing
- **o8://skills/testing-integration-patterns** - Advanced integration patterns with test containers
- **o8://skills/testing-e2e-best-practices** - E2E testing with Playwright, page objects, flaky test prevention
