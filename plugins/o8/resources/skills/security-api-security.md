...
relatedResources:
  - o8://examples/security/api-rate-limiting-implementation
...
For complete implementation code, see: `o8://examples/security/api-rate-limiting-implementation`
...
### Parent Skills
- **OWASP Top 10**: `o8://skills/security-owasp-top10`
...
- **OAuth 2.0**: `o8://skills/security-authentication-oauth`
