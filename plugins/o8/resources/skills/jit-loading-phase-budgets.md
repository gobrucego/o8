...
- o8://agents/database-expert (1200 tokens)
- o8://skills/testing (1000 tokens)
- o8://skills/deployment (900 tokens)
- o8://patterns/microservices (800 tokens)
...
**→ Load:** `o8://agents/match?query=research+requirements&mode=index&maxResults=3`
(800 tokens, 100% utilized)

## Phase 2: Design (15-30%)
**→ Load:** `o8://match?query=${tech-stack}+architecture&categories=agent,pattern&mode=index&maxResults=8`
(1500 tokens, 95% utilized)

## Phase 3: Implementation (30-85%)
**→ Load:** `o8://match?query=${tech}+${features}&categories=agent,skill,example&mode=index&maxResults=10`
(2500 tokens, 90% utilized)

## Phase 4: Integration (85-100%)
**→ Load:** `o8://skills/match?query=testing+integration+${tech}&mode=index&maxResults=5`
...
## Phase 1
**→ Dynamic:** `o8://match?query=${project-description}&categories=agent&mode=index&maxResults=8`
...
**→ Load:** `o8://agents/match?query=research+${domain}&mode=index&maxResults=3`
