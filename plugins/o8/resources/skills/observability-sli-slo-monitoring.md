...
- o8://skills/observability-structured-logging - Logs for incident investigation
- o8://skills/observability-metrics-prometheus - Metrics foundation for SLI/SLO
- o8://skills/observability-distributed-tracing - Traces for debugging SLO violations

**SRE & Reliability:**
- o8://skills/observability-sli-slo-monitoring - SLI/SLO practices (this skill)
- o8://guides/prometheus-monitoring-setup - Monitoring infrastructure setup

**Infrastructure:**
- o8://patterns/architecture-microservices - Distributed system design
- o8://skills/error-handling-resilience - Building reliable systems
