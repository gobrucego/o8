...
**Alternative Tool:**
- o8://skills/iac-pulumi-programming - Infrastructure as code with programming languages

**Cross-Cutting Concepts:**
- o8://skills/iac-state-management - Remote state, locking, and drift detection
- o8://skills/iac-testing-validation - Testing infrastructure code with Terratest
