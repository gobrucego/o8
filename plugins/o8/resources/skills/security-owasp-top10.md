...
relatedResources:
  - o8://skills/security-api-security
  - o8://skills/security-authentication-jwt
  - o8://skills/security-authentication-oauth
...
**For detailed implementation:** See `o8://skills/security-secrets-management`
...
**For detailed implementation:** See `o8://skills/security-input-validation`
...
**For detailed implementation:** See `o8://skills/security-api-security`
...
- JWT authentication: `o8://skills/security-authentication-jwt`
- OAuth 2.0/OIDC: `o8://skills/security-authentication-oauth`
...
- **OAuth 2.0 & OpenID Connect**: `o8://skills/security-authentication-oauth`
  - Authorization code flow with PKCE
  - Social login integration
  - Token management best practices

### API Security
- **API Security Patterns**: `o8://skills/security-api-security`
...
- **Input Validation**: `o8://skills/security-input-validation`
...
- **Secrets Management**: `o8://skills/security-secrets-management`
