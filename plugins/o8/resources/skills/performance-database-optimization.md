...
- o8://skills/performance-api-optimization - API optimization patterns that depend on efficient database queries
- o8://skills/performance-profiling-techniques - Profile to identify database bottlenecks and slow queries

**Related Patterns:**
- o8://patterns/database-indexing-strategies - Advanced indexing strategies and trade-offs
- o8://patterns/database-query-optimization - Query optimization patterns and techniques
- o8://patterns/database-connection-pooling-scaling - Connection pooling best practices

**Implementation Examples:**
- o8://examples/go-postgres-pgx - PostgreSQL with Go using pgx driver
- o8://examples/rust-sqlx-queries - Rust SQLx query patterns
- o8://examples/typescript-rest-api-complete - Complete TypeScript API with database integration
