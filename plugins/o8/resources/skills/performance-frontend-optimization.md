...
- o8://skills/performance-api-optimization - API optimization to complement frontend performance
- o8://skills/performance-profiling-techniques - Browser profiling tools and performance diagnostics

**Related Patterns:**
- o8://patterns/performance-caching - Client-side caching strategies including service workers
- o8://patterns/architecture-microservices - Frontend architecture patterns for large applications

**Implementation Examples:**
- o8://examples/typescript-rest-api-complete - Full-stack TypeScript application with frontend optimization
