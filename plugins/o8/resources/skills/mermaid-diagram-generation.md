...
**→ See comprehensive examples:** o8://examples/diagrams/mermaid-c4-architecture, o8://examples/diagrams/mermaid-sequence-flow
...
**→ See complete C4 examples:** o8://examples/diagrams/mermaid-c4-architecture
...
**→ See detailed sequence examples:** o8://examples/diagrams/mermaid-sequence-flow
...
**→ See complex flow examples:** o8://examples/diagrams/mermaid-sequence-flow
...
**→ See state machine examples:** o8://examples/diagrams/mermaid-sequence-flow
...
**→ See ER diagram examples:** o8://examples/diagrams/mermaid-sequence-flow
...
**→ See all common patterns:** o8://examples/diagrams/mermaid-c4-architecture, o8://examples/diagrams/mermaid-sequence-flow
