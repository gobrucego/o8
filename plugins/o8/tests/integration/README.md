...
- Content includes `o8://` resource references

### ✅ 4. List All Static Resources (7 tests)
- Returns array of resources
- Includes agent resources (`o8://agents/*`)
- Includes skill resources (`o8://skills/*`)
- Includes example resources (`o8://examples/*`)
- Includes pattern resources (`o8://patterns/*`)
...
- Read specific resource by URI (`o8://agents/typescript-developer`)
- Returns content array with text property
- Content is substantial (>500 characters)
- Correct MIME type (text/markdown or text/plain)
- Response includes the requested URI
- Can read nested resource paths (`o8://examples/typescript/api-rest`)
...
- Error: `MCP error -32602: Resource o8://agents/match?query=typescript+api not found`
