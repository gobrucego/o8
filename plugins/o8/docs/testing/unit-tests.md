...
- URI generation (o8://category/resource)
- MIME type detection
- Content caching
...
- URIs follow o8:// protocol format
...
**What It Tests**:
- Static URI parsing (o8://category/resource)
- Dynamic URI parsing (o8://category/match?query=...)
