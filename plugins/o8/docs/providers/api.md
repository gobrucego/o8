...
Default port can be changed via `O8_HTTP_PORT` environment variable.
...
```bash
# Local resource
curl "http://localhost:3000/api/resource?uri=o8://agents/typescript-developer"
...
curl "http://localhost:3000/api/resource?uri=o8://match?query=typescript+api"
```
...
```json
{
  "patterns": [
    {
      "id": "authentication",
      "uri": "o8://patterns/security/authentication",
