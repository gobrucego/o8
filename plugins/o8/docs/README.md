...
```
o8://match?query=typescript+api+authentication&maxTokens=2500
```
...
```
o8://match?query=error+handling+retry&mode=catalog&maxResults=10
```
...
All URIs in documentation follow the `o8://` protocol:

```
o8://category/resource
o8://category/fragment-id
o8://match?query=search+terms
o8://category/match?query=search+terms
```
