...
const agent = await readResource('o8://agents/typescript-developer');
const skill = await readResource('o8://skills/async-patterns');
```
...
const result = await readResource(
  'o8://match?query=typescript+developer&mode=full&maxTokens=2500&categories=agents'
);
