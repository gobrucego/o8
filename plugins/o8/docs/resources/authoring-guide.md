...
o8://match?query=typescript+generics+constraints&mode=index
...
o8://match?query=typescript+api+error+handling&maxTokens=3000
...
o8://agents/your-fragment-id

# Dynamic loading (query-based)
o8://match?query=your+expected+keywords&mode=index

# Category-specific matching
o8://agents/match?query=your+keywords
```
...
```markdown
For async patterns, see [typescript-async-patterns](o8://agents/typescript-async-patterns).
```
...
For foundational knowledge, see [typescript-core](o8://agents/typescript-core).

Related patterns:
- [Error Handling](o8://skills/error-handling-resilience)
...
For async error handling, see [error-handling-async](o8://skills/error-handling-async).
For logging strategies, see [error-handling-logging](o8://skills/error-handling-logging).
```
