...
**Loading:**
```typescript
o8://match?query=resilient+api+error+retry&maxTokens=2500
...
**Loading:**
```typescript
o8://agents/match?query=fastapi+pydantic+async&maxTokens=3000
...
**URI:**
```typescript
o8://match?query=typescript+express+jwt+error+handling&maxTokens=3000
```
...
**URI:**
```typescript
o8://match?query=kubernetes+nodejs+health+checks+monitoring&maxTokens=3000
```
...
**URI:**
```typescript
o8://agents/match?query=react+hooks+context+api+integration&maxTokens=3000
```
...
2. **Update frontmatter** with deprecation info
   ```yaml
   deprecated: true
   deprecatedBy: o8://agents/new-fragment-id
...
```typescript
// Test assembly
o8://match?query=typescript+api+jwt&maxTokens=3000
