...
|----------|---------|----------------|------------|-------------|
| **agents** | AI agent expertise and specializations | 95 | 720 | `o8://agents/typescript-core` |
| **skills** | Reusable techniques and best practices | 48 | 680 | `o8://skills/error-handling-resilience` |
| **patterns** | Design and architectural patterns | 34 | 850 | `o8://patterns/autonomous-organization` |
| **examples** | Code examples and implementations | 15 | 620 | `o8://examples/express-jwt-auth` |
| **guides** | Setup and configuration guides | 10 | 780 | `o8://guides/aws-eks-cluster` |
| **best-practices** | Code standards and quality guidelines | 6 | 740 | `o8://best-practices/api-design-rest` |
| **workflows** | Execution strategies and processes | 13 | 640 | `o8://workflows/workflow-new-project` |
