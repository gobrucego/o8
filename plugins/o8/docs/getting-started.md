...
```
o8://match?query=error+handling+retry&maxTokens=2000
```
...
```
o8://match?query=typescript+rest+api+authentication&maxTokens=2500
```
...
```
o8://match?query=your+topic&mode=catalog&maxResults=20
```
...
```
# Search for patterns
o8://patterns/match?query=circuit+breaker+resilience&mode=catalog
...
2. Add category filters: `o8://agents/match?...`
