...
```
o8://match?query=typescript+api&mode=catalog&maxResults=10
```
...
```
Request Type: Read Resource
URI: o8://match?query=api+design+patterns&mode=catalog&maxResults=10
...
```
Request Type: Read Resource
URI: o8://match?query=typescript+react+api+testing&categories=agents,skills,examples&mode=catalog
