...
o8://agents/python-expert

<!-- After: Modular approach (2KB core + 5KB advanced) -->
o8://agents/python-expert-core
o8://agents/python-expert-advanced (loaded only when needed)
...
# Skill: API Security
See examples:
- o8://examples/security/jwt-auth
- o8://examples/security/oauth-flows
...
# Output:
# ⚠️ o8://agents/legacy-system - Efficiency: 52.1% - Loads: 8
# ⚠️ o8://workflows/cloud-migration - Efficiency: 64.7% - Loads: 5
```
