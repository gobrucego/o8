...
3. **Dynamic resource loading:**
   ```
   o8://match?query=typescript+rest+api+authentication+postgresql&maxTokens=2500
   ```
...
**Query:**
```
o8://match?query=typescript+api&mode=catalog
```
...
**Query:**
```
o8://skills/match?query=testing+unit+integration
```
...
**Query:**
```
o8://match?query=async+error+handling+retry+timeout
```
...
**Query:**
```
o8://match?query=testing+patterns&mode=catalog&maxResults=15
```
...
```
o8://examples/express-error-handling
→ 650 tokens
```
...
**Loading:**
```
o8://skills/error-handling-resilience      # 720 tokens
o8://skills/api-rate-limiting              # 580 tokens
o8://skills/caching-strategies             # 650 tokens
o8://skills/monitoring-observability       # 800 tokens
```
...
```
# Step 1: Discover
o8://match?query=authentication+jwt&mode=catalog
...
o8://skills/error-handling-resilience  # 720 tokens
o8://skills/testing-unit  # 680 tokens

# Step 3: Load examples only when stuck (on-demand)
o8://examples/express-error-handling  # 850 tokens
```
