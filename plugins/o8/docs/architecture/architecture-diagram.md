...
└─────┬─────┘
      │
      │ Read Resource
      │ o8://match?query=typescript+async&maxTokens=2500&mode=catalog
      │
      ▼
┌──────────────────────────────────────────────────────────────┐
...
```
Static URI: o8://agents/typescript-developer
                    │
                    ▼
        ┌─────────────────────┐
        │ uriToFilePath()     │
...
```
Dynamic URI: o8://match?query=typescript+async&mode=catalog
                    │
                    ▼
        ┌─────────────────────────┐
        │ Parse Query Params       │
...
```
Request: o8://agents/typescript-developer

1. Check Resource Cache (Level 3)
   ├─ Key: "o8://agents/typescript-developer"
