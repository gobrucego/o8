...
│  │  • Static: o8://agents/typescript-developer             │   │
│  │  • Dynamic: o8://match?query=typescript+api             │   │
...
- Category-specific matching (e.g., `o8://agents/match?query=...`)
- Global cross-category matching (e.g., `o8://match?query=...`)
...
**URI Types:**
- **Static**: `o8://agents/typescript-developer`
- **Dynamic (category-specific)**: `o8://agents/match?query=build+api`
- **Dynamic (global)**: `o8://match?query=python+async`
...
- Examples referenced via `o8://examples/...` URIs
