...
3. **Dynamic Templates**
   - MCP supports wildcard URIs (`o8://agents/match{+rest}`)
   ...
   ```json
   {
     "index": {
       "scenario-hash": {
         ...
         "uri": "o8://agents/typescript-async",
         "category": "agent",
         "estimatedTokens": 800
       }
     }
...
**Core Concepts:**
- o8://skills/performance-optimization (foundational patterns)

**Specialized Topics:**
- o8://skills/performance-database-optimization (database-specific)
- o8://skills/performance-frontend-optimization (frontend-specific)

**Patterns:**
- o8://patterns/performance-caching (caching strategies)
- o8://patterns/database-query-optimization (query optimization)

**Examples:**
- o8://examples/express-error-handling (practical implementation)
```
...
1. **Project Manager Agent**
   ...
   └── o8://agents/project-manager-advanced
...
2. **Knowledge Base Agent**
   ...
   ├── Reference to advanced module
   └── o8://agents/knowledge-base-agent-advanced
