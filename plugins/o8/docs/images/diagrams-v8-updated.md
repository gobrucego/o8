...
graph TB
    ...
    subgraph "MCP Server - orchestr8 v8.0"
        ...
        subgraph "Core Components"
            ...
            URIParser["URI Parser<br/>(o8:// + cross-refs)"]
...
sequenceDiagram
    ...
    Claude->>MCP: o8://match?query=typescript+api&mode=index
    ...
    Claude->>MCP: o8://agents/typescript-core
    ...
    Claude->>MCP: o8://examples/express-jwt-auth
    ...
    Claude->>MCP: o8://agents/typescript-api-development
...
graph TB
    subgraph "Phase 1: Example Extraction"
        ...
        P1_After["77 extracted example files<br/>o8:// URI references<br/>~45,000 tokens saved"]
