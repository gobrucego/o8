...
- [TypeScript API Development](o8://agents/typescript-api-development)
- [TypeScript Async Patterns](o8://agents/typescript-async-patterns)
- [TypeScript Testing](o8://agents/typescript-testing)
```
...
- [TypeScript Core](o8://agents/typescript-core)
- [Error Handling Patterns](o8://skills/error-handling-api-patterns)
- [API Design REST](o8://skills/api-design-rest)
```
...
- [TypeScript Core](o8://agents/typescript-core)
- [Error Handling Patterns](o8://skills/error-handling-api-patterns)
- [API Design](o8://skills/api-design-rest)
...
**Core prerequisite:**
- [Python Core](o8://agents/python-core) - Required foundation

**Related specializations:**
- [FastAPI Validation](o8://agents/python-fastapi-validation)
- [FastAPI Middleware](o8://agents/python-fastapi-middleware)

**Complementary skills:**
- [Python Async Fundamentals](o8://agents/python-async-fundamentals)
```
...
3. **Test specialized queries:**
   ```
   o8://agents/match?query=typescript+api+express
   o8://agents/match?query=typescript+rest+backend
   ```

4. **Test composition:**
   ```
   o8://agents/match?query=typescript+api+async
