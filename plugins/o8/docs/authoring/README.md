...
Example File (o8://examples/example-name):
...
- **examples:** Array of o8:// URIs to example files
- **advancedTopics:** Array of o8:// URIs to advanced modules
...
estimatedTokens: 650
examples:
  - o8://examples/typescript-generics-advanced
---
