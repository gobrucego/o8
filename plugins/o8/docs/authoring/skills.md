...
- [Related Skill 1](o8://skills/related-1)
- [Related Skill 2](o8://skills/related-2)
```
...
o8://skills/match?query=retry+failed+requests

# 4. Test cross-domain queries
o8://skills/match?query=api+resilience

# 5. Verify complementary loading
o8://match?query=resilient+api&categories=skill,pattern
```
...
- [Error Handling: API Patterns](o8://skills/error-handling-api-patterns)
- [Observability: Structured Logging](o8://skills/observability-structured-logging)
- [Performance: API Optimization](o8://skills/performance-api-optimization)
```
...
- [Testing: Unit](o8://skills/testing-unit)
- [Testing: E2E Best Practices](o8://skills/testing-e2e-best-practices)
- [Testing: Strategies](o8://skills/testing-strategies)
```
...
- [Error Handling: API Patterns](o8://skills/error-handling-api-patterns)
- [Security: API Security](o8://skills/security-api-security)
- [API Documentation Patterns](o8://skills/api-documentation-patterns)
```
