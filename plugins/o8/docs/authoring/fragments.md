...
- [Error Handling Patterns](o8://skills/error-handling-resilience)
- [Testing Strategies](o8://skills/testing-integration-patterns)
- [API Security](o8://skills/security-api-security)

## See Also

- Pattern: [Microservices Architecture](o8://patterns/architecture-microservices)
- Example: [Express JWT Auth](o8://examples/express-jwt-auth)
```
...
- [TypeScript Retry Patterns](o8://examples/typescript-retry-patterns)
- [Python Retry Patterns](o8://examples/python-retry-patterns)
- [Go Retry Patterns](o8://examples/go-retry-patterns)
...
estimatedTokens: 700
advancedTopics:
  - o8://agents/python-async-concurrency
  - o8://agents/python-async-context-managers
---

Core async/await concepts and event loop basics.

**For advanced topics:**
- [Advanced Concurrency Patterns](o8://agents/python-async-concurrency)
- [Async Context Managers](o8://agents/python-async-context-managers)
...
o8://match?query=typescript+api&categories=agent
o8://match?query=express+middleware&categories=agent,skill
o8://match?query=rest+api+typescript&minScore=20
```

**Method 2: Using MCP Resources**
```markdown
Load resource and check if your fragment appears:
o8://agents/match?query=typescript+api+development
o8://skills/match?query=error+handling+async
o8://patterns/match?query=microservices+architecture
```
