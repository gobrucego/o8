...
- [${Parent-Skill}](o8://skills/${parent-skill-id}) - Required foundation

**Parent Skill (if this is a child):**
- [${Parent-Skill}](o8://skills/${parent-skill-id})

**Complementary Skills (Phase 2 - Cross-references):**
- [${Related-Skill-1}](o8://skills/${skill-id})
- [${Related-Skill-2}](o8://skills/${skill-id})

**Related Patterns:**
- [${Related-Pattern}](o8://patterns/${pattern-id})

**Detailed Examples (Phase 1 - if extracted):**
- [${Related-Example}](o8://examples/${example-id})
