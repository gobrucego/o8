...
**→ JIT Load:** o8://match?query=${query}&maxTokens=${budget}
...
**→ JIT Load:** o8://agents/match?query=${query}&maxTokens=${budget}
...
**→ JIT Load:** o8://skills/match?query=debugging&maxTokens=800
...
**→ JIT Load:** o8://match?query=${bug-description}+fix&maxTokens=1500
...
**→ JIT Load:** o8://skills/match?query=testing&maxTokens=600
...
**→ Load:** o8://match?query=${technology}+${feature}
```
...
```markdown
## Phase 1: Research
**→ Load:** o8://skills/match?query=research&maxTokens=1000

## Phase 2: Implementation
**→ Load:** o8://agents/match?query=${tech}&maxTokens=2000

## Phase 3: Testing
**→ Load:** o8://skills/match?query=testing&maxTokens=800
```
