...
# examples: [o8://examples/example-id]  # Example extraction (Phase 1)
# advancedTopics: [o8://agents/advanced-module]  # Progressive loading (Phase 3)
---
...
- [${Technology} Core](o8://agents/${technology}-core) - Required foundation

**Core Agent (if you're a specialized agent):**
- [${Technology} Core](o8://agents/${technology}-core)

**Specialized Agents (Phase 2 - Cross-references):**
- [${Technology} ${Other-Specialization}](o8://agents/${technology}-${other-specialization})
- [${Technology} ${Another-Specialization}](o8://agents/${technology}-${another-specialization})

**Complementary Skills (Phase 2 - Cross-references):**
- [${Related-Skill}](o8://skills/${skill-id})
- [${Another-Skill}](o8://skills/${skill-id})

**Detailed Examples (Phase 1 - if extracted):**
- [${Example-Name}](o8://examples/${example-id})

**Advanced Topics (Phase 3 - if split for progressive loading):**
- [${Advanced-Topic}](o8://agents/${advanced-module-id})
...
- [ ] Added `examples: [o8://examples/...]` field?
