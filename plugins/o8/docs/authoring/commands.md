...
- **Dynamic:** Loads expertise via `o8://` URIs
...
**→ Load:** o8://match?query=${technology}+${feature}&maxTokens=1000
```
...
o8://match?query=<need>&categories=<cats>
...
**→ Load:** o8://skills/match?query=research+${domain}&maxTokens=1000
...
**→ Load:** o8://skills/match?query=feature+planning+requirements&maxTokens=800
...
**→ Load:** o8://patterns/match?query=design+architecture&maxTokens=1000
...
**→ Load:** o8://match?query=${feature-description}+implementation&categories=agent,skill,example&maxTokens=2500
...
**→ Load:** o8://skills/match?query=testing+validation&maxTokens=800
...
```
o8://match?query=<need>&categories=<cats>&minScore=15
```
