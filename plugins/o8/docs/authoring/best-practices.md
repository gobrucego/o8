...
examples:
  - o8://examples/typescript-retry-patterns
  - o8://examples/python-retry-patterns
---
...
- [Unit Testing](o8://skills/testing-unit)
- [Integration Testing](o8://skills/testing-integration-patterns)
- [E2E Testing](o8://skills/testing-e2e-best-practices)
...
## Advanced Topics
- [Concurrency Patterns](o8://agents/python-async-concurrency)
- [Context Managers](o8://agents/python-async-context-managers)
...
2. Test core queries (4-6 per fragment)
   o8://match?query=core+terms
   o8://match?query=specialized+terms
