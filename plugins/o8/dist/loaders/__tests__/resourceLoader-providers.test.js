...
describe("ResourceLoader Provider Integration", () => {
    ...
    describe("Resource Fetching", () => {
        ...
        it("should handle dynamic resource URIs", async () => {
            try {
                const uri = "o8://agents/match?query=typescript+api&maxResults=3&mode=catalog";
                const content = await resourceLoader.loadResourceContent(uri);
    ...
    describe("Error Handling", () => {
        ...
        it("should handle resource not found errors", async () => {
            await assert.rejects(async () => {
                await resourceLoader.loadResourceContent("o8://nonexistent/resource-xyz-123");
...
//# sourceMappingURL=resourceLoader-providers.test.js.map