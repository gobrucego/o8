...
export class ResourceLoader {
    ...
    async _loadDynamicResource(uri, parsed) {
        ...
        const useIndexLookup = parsed.matchParams.mode !== "catalog" && // Only use catalog if explicitly requested
    ...
    async getResourcesByCategory(category) {
        ...
        return this.resourceIndex
            ...
            uri: `o8://${fragment.id}`,
            description: fragment.capabilities?.slice(0, 3).join(", ") || "No description", // Use capabilities as description
            tags: fragment.tags || [],
