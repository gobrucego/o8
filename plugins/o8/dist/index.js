...
const HTTP_MODE = process.env.O8_HTTP === "true" || process.env.O8_HTTP === "1";
...
class Orchestr8Server {
    ...
    constructor() {
        ...
        this.resourceLoader = null; // Temporary
        this.stats = null; // Temporary - will be initialized with token metrics
    }
    async initialize() {
    ...
    registerResourceRegistry(resources) {
        this.server.registerResource("resource-registry", "o8://registry", {
