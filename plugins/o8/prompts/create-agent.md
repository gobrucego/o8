...
**→ Load:** o8://skills/match?query=fragment+metadata+authoring&mode=index&maxResults=5
...
**→ Load:** o8://match?query={{task}}&categories=agent,skill,example&mode=index&maxResults=10
...
**→ Load:** o8://skills/match?query=fragment+testing+discovery&mode=index&maxResults=3
