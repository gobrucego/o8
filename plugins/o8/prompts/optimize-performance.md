...
**→ Load:** o8://skills/match?query=profiling+performance+analysis&mode=index&maxResults=5
...
**→ Load:** o8://match?query={{task}}+optimization+performance&categories=agent,skill,pattern&mode=index&maxResults=8
...
**→ Load:** o8://skills/match?query=performance+testing+benchmarking&mode=index&maxResults=5
...
**→ Load:** o8://skills/match?query=monitoring+observability+alerting&mode=index&maxResults=3
