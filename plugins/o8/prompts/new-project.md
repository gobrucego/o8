...
**→ Load:** o8://match?query={{task}}+architecture+planning&categories=agent,pattern&mode=index&maxResults=8
...
**→ Load:** o8://match?query={{task}}+setup+configuration&categories=agent,skill,example&mode=index&maxResults=8
...
**→ Load:** o8://match?query={{task}}+implementation&categories=agent,skill,example&mode=index&maxResults=10
...
**→ Load:** o8://match?query={{task}}+testing+deployment&categories=skill,guide&mode=index&maxResults=8
