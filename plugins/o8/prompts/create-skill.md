...
**→ Load:** o8://skills/match?query=skill+authoring+fragment&mode=index&maxResults=5
...
**→ Load:** o8://skills/match?query=fragment+metadata&mode=index&maxResults=3
...
**→ Load:** o8://match?query={{task}}&categories=skill,pattern,example&mode=index&maxResults=8
...
**→ Load:** o8://skills/match?query=testing+discovery&mode=index&maxResults=3
