...
**→ Load:** o8://skills/match?query=cicd+pipeline+planning&mode=index&maxResults=5
...
**→ Load:** o8://match?query={{task}}+build+test+automation&categories=skill,guide,example&mode=index&maxResults=8
...
**→ Load:** o8://match?query={{task}}+deployment+automation&categories=skill,guide,example&mode=index&maxResults=8
...
**→ Load:** o8://skills/match?query=cicd+monitoring+optimization&mode=index&maxResults=3
