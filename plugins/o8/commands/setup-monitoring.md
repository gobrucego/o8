...
**→ Load:** o8://match?query=observability+monitoring+architecture+slo&categories=pattern,guide&mode=index&maxResults=5
...
**→ Load:** o8://match?query=prometheus+grafana+metrics&categories=guide,example&mode=index&maxResults=5
...
**→ Load:** o8://match?query=application+instrumentation+metrics+logging&categories=guide,example&mode=index&maxResults=5
...
**→ Load:** o8://match?query=logging+loki+elasticsearch&categories=guide,example&mode=index&maxResults=5
...
**→ Load:** o8://match?query=distributed+tracing+jaeger+tempo&categories=guide,example&mode=index&maxResults=5
...
**→ Load:** o8://match?query=grafana+dashboards+visualization&categories=guide,example&mode=index&maxResults=5
...
**→ Load:** o8://match?query=alerting+prometheus+pagerduty&categories=guide,example&mode=index&maxResults=5
...
**→ Load:** o8://match?query=monitoring+optimization+high+availability&categories=guide&mode=index&maxResults=3
