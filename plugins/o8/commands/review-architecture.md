...
**→ Load:** o8://match?query=architecture+discovery+mapping&categories=pattern,skill&mode=index&maxResults=5
...
**→ Load:** o8://match?query=architecture+patterns+evaluation&categories=pattern,skill&mode=index&maxResults=5
...
**→ Load:** o8://workflows/workflow-review-architecture
...
**→ Load:** o8://match?query=scalability+performance+architecture&categories=pattern,skill&mode=index&maxResults=5
...
**→ Load:** o8://match?query=security+architecture+defense+depth&categories=pattern,skill&mode=index&maxResults=5
...
**→ Load:** o8://match?query=technical+debt+code+quality&categories=skill,pattern&mode=index&maxResults=5
...
**→ Load:** o8://match?query=api+design+integration+resilience&categories=pattern,skill&mode=index&maxResults=5
...
**→ Load:** o8://match?query=architecture+report+decision+records&categories=skill&mode=index&maxResults=3
