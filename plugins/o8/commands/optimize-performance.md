...
**→ Load:** o8://workflows/workflow-performance-optimization
...
**→ Load:** o8://match?query=performance+optimization+caching+database+queries&categories=skill,pattern&mode=index&maxResults=8
...
**→ Load:** o8://match?query=performance+testing+benchmarking+load+testing&categories=skill&mode=index&maxResults=5
...
**→ Load:** o8://match?query=monitoring+observability+performance+metrics&categories=guide,skill&mode=index&maxResults=5
