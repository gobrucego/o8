...
**→ Will load:** o8://agents/git-expert (already loaded)
- Core commands and workflows
- Repository management
- Branching and merging basics

### For Commit Best Practices
**→ Will load:** o8://skills/git-commit-best-practices (~750 tokens)
...
**→ Will load:** o8://skills/git-branching-strategies (~820 tokens)
...
### For Pull Requests
**→ Will load:** o8://skills/git-pr-workflow (~750 tokens)
...
### For Rebase vs Merge
**→ Will load:** o8://skills/git-rebase-merge (~820 tokens)
...
**→ Will load:** o8://skills/git-advanced-commands (~880 tokens)
...
### For GitHub CLI
**→ Will load:** o8://skills/github-cli-essentials (~850 tokens)
...
### For Git Hooks
**→ Will load:** o8://skills/git-hooks-automation (~880 tokens)
...
### For Security
**→ Will load:** o8://skills/git-security-practices (~870 tokens)
- GPG signing setup
...
### For Troubleshooting
**→ Will load:** o8://agents/git-troubleshooter (~1,100 tokens)
...
**→ Will load:** o8://agents/github-workflow-specialist (~1,050 tokens)
...
**→ o8://examples/git/git-commit-examples** (~650 tokens)
- Good vs bad commit examples
- Conventional commit format
- Multi-line commit templates

**→ o8://examples/git/git-pr-templates** (~620 tokens)
- Feature PR template
- Bugfix PR template
- Hotfix PR template

**→ o8://examples/git/git-hooks-implementations** (~680 tokens)
- Husky pre-commit hooks
- Pre-commit framework config
- Native Git hooks

**→ o8://examples/git/github-actions-workflows** (~690 tokens)
- CI/CD pipeline examples
- Multi-environment deployments
- Automated releases

**→ o8://examples/git/git-troubleshooting-scenarios** (~670 tokens)
...
**→ o8://patterns/git-collaboration-workflow** (~1,094 tokens)
- Team collaboration patterns
- Code review culture
- Merge strategies
- Conflict resolution workflows

**→ o8://patterns/git-release-management** (~1,073 tokens)
- Semantic versioning workflows
- Release branch strategies
- Automated changelog generation
- Hotfix processes

**→ o8://patterns/git-monorepo-strategies** (~1,352 tokens)
