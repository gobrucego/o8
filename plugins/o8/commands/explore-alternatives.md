...
**→ Load:** o8://match?query=problem+analysis+solution+discovery&categories=skill,pattern&mode=index&maxResults=5
...
**→ Load:** o8://workflows/workflow-explore-alternatives
...
**→ Load:** o8://match?query=evaluation+comparison+trade-offs+pareto&categories=skill,pattern&mode=index&maxResults=5
...
**→ Load:** o8://match?query=recommendation+implementation+roadmap+adr&categories=skill&mode=index&maxResults=3
