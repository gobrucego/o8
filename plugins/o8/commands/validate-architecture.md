...
o8://agents/research-specialist                 # Hypothesis formulation (~800 tokens)
o8://skills/requirement-analysis-framework      # Assumption extraction (~600 tokens)

# Phase 2: Test Design (per assumption type)
o8://match?query=<architecture>+validation&mode=index&maxResults=8

# Examples based on assumption type:
o8://skills/performance-profiling-techniques    # For performance assumptions (~700 tokens)
o8://skills/observability-metrics-prometheus    # For monitoring assumptions (~600 tokens)
o8://patterns/architecture-decision-records     # For design decisions (~800 tokens)

# Phase 3: Validation Execution
o8://match?query=testing+benchmark+validation&mode=index&maxResults=5

# Phase 4: Risk Assessment
o8://patterns/trade-off-analysis-framework      # Risk evaluation (~500 tokens)
```
